...
/**
 * This class contains all the constants used as simulation arguments.
...
public class ConsoleConstants {
	 ...
	 */
	public static String OPERATION_TO_PERFORM = "-o";
	
	/**
	 * Network creation task key
	 */
	public static String NETWORK_CREATION_TASK = "NetworkCreation";
